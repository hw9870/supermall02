...
<!--          </tr>-->
<!--        </table>-->
<!--&lt;!&ndash;      <table v-for="(table,index) in paramInfo.infos" :key="index">&ndash;&gt;-->
<!--&lt;!&ndash;        <tr v-for="(tr,indey) in table" :key="indey">{{tr.key}}&ndash;&gt;-->
<!--&lt;!&ndash;          <td v-for="(td,indez) in table" :key="indez">{{td.value}}</td>&ndash;&gt;-->
<!--&lt;!&ndash;        </tr>&ndash;&gt;-->
<!--&lt;!&ndash;      </table>&ndash;&gt;-->
